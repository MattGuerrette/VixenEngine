...
public:
	...
	inline static bool StringEqual(const wchar_t* p, const wchar_t* q) {
		if (wcscmp(p, q) != 0)
			return false;
		else return true;
	}
...
public:
    ...
    */
	...
	/**
		...
		NOTE:
			This is altered source code that allows for loading of files with UNICODE
			headings on WINDOWS. (Linux assumes UTF-8)
		Desc:
			Loads an XML from disk.
