...
namespace Vixen {
	...
	{
	public:
		PrimitiveTube(float outRadius, float inRadius, float height, size_t subdivisions, Color c);
	...
	private:
		...
		std::vector<PositionColor> m_outBodyVerts;
		std::vector<PositionColor> m_inBodyVerts;
