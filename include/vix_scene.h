...
namespace Vixen
{
	class VIX_API Scene
	{
	 ...
	 private:
		static GameObject*
		ParseGameObject(Scene* scene, const tinyxml2::XMLElement* element);
		static Transform* ParseTransform(const tinyxml2::XMLElement* element);

		static std::vector<Component*>
		ParseComponents(Scene* scene, const tinyxml2::XMLElement* element);
		static Component*
		ParseCameraComponent(Scene* scene, const tinyxml2::XMLElement* element);
		...
		static Component* ParsePauseScript(const tinyxml2::XMLElement* element);
		static Component* ParseFpsScript(const tinyxml2::XMLElement* element);
		static Component* ParseMineshaftScript(const tinyxml2::XMLElement* element);
		static Component* ParsePlayerScript(const tinyxml2::XMLElement* element);
	};
}
#endif
